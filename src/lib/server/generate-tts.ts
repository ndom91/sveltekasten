...
//
// const ttsCreate = async (payload: EdgeSpeechPayload, speechFilePath: string) => {
//   const response = await tts.create(payload)
//   const mp3Buffer = Buffer.from(await response.arrayBuffer())
//
//   // new Blob(mp3Buffer, { type: "audio/mpeg" })
//   writeFileSync(speechFilePath, mp3Buffer)
// }
//
// export const generateTTS = async (id: string, inputText: string): Promise<string> => {
//   console.log("generateTTS.args", { id, inputText })
//   const payload = {
//     input: inputText,
//     options: {
...
//   }
//
//   const targetDir = join(resolve("."), "static", "tts", id)
//   const speechFilePath = resolve(targetDir, "speech.mp3")
//
//   if (!existsSync(targetDir)) {
//     mkdirSync(targetDir, {
//       recursive: true,
//     })
//     await ttsCreate(payload, speechFilePath)
//   } else {
//     // Parent dir exists, but lets ensure the mp3 is actually
//     // there as well before potentially kicking off expensive
//     // ttsCreate call
//     if (!existsSync(speechFilePath)) {
//       await ttsCreate(payload, speechFilePath)
//     }
//   }
//
